...
export const mixpanel_track = function ({ label, options }) {
    var _a;
    if (typeof window !== "object" || !((_a = window === null || window === void 0 ? void 0 : window.mixpanel) === null || _a === void 0 ? void 0 : _a.track))
        return;
...
const mixpanel_track_event_now = function ({ label, options }) {
    ...
    if (!label || !options)
        return;
    if (DEBUG1)
        console.warn('mixpanel track "' + label + '"', options);
    (_a = window === null || window === void 0 ? void 0 : window.mixpanel) === null || _a === void 0 ? void 0 : _a.track(label, options);
};
const mixpanel_track_all_from_queue = function () {
    if (window.analytics_queue.length) {
        if (DEBUG2)
            console.log("mixpanel_track_all_from_queue");
...
const mixpanel_track_one_from_queue = function () {
    if (window.analytics_queue.length) {
        if (DEBUG2)
            console.log("mixpanel_track_one_from_queue");
...
const mixpanel_add_to_queue = function ({ label, options = {} }) {
    if (typeof window !== "object" || !window.mixpanel) {
        if (typeof window === "object")
            console.warn("!window.mixpanel");
    }
    if (DEBUG2)
        console.log("mixpanel_add_to_queue");
    // init
