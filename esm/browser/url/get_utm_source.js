...
export default function get_utm_source() {
    ...
    if (referer) {
        if (referer.includes("utm_source=")) {
             ...
             */
            out = ((_c = (_b = (_a = referer.split("utm_source=")) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.split(/[^\w]+/)) === null || _c === void 0 ? void 0 : _c[0]) || ""; // get just the "facebook" part from ...?utm_source=facebook&...
        }
        if (out === "direct") {
            /*
