 ...
 */
export default function objects_are_equal(object1, object2) {
    const objKeys1 = object1 && Object.keys(object1);
    const objKeys2 = object2 && Object.keys(object2);
    if ((objKeys1 === null || objKeys1 === void 0 ? void 0 : objKeys1.length) !== (objKeys2 === null || objKeys2 === void 0 ? void 0 : objKeys2.length))
        return false;
